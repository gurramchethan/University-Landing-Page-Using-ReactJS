...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "978a9bdb-0d82-4bb8-aa54-71923908407d");
  ...
  return (
    <div className='contact'>
        <div className="contact-col">
            ...
            Your feedback, questions, and suggestions are important to 
             us as we strive to provide exceptional service to our university community.</p>
            <ul>
                <li><img src={mail_icon} alt="" />Contact@university.dcu</li>
        ...
        <div className="contact-col">
            <form onSubmit={onSubmit}>
                ...
                <button type='submit' className='btn-1'>Submit Now <img src={white_arrow} alt="" /></button>
            </form>
            <span>{result}</span>
        </div>
    </div>
